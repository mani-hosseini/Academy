        ...
        <div>
            <div className={"custom-box m-0  relative flex items-end mt-[300px]"}>
                <div
                    ...
                    <img className={'lg:block lg:w-[250px] sm:w-full'} src="../../../../src/assets/nav/w.png"
                         alt=""/>
                    <img className={'lg:block sm:hidden'} src="../../../../src/assets/nav/1.png" alt=""/>
                    <img className={'lg:block sm:hidden'} src="../../../../src/assets/nav/4.png" alt=""/>
                    <img className={'lg:block sm:hidden'} src="../../../../src/assets/nav/3.png" alt=""/>
                </div>
                <div className={'mt-[40px]  w-full'}>
                    <div>
                        <div className={'lg:flex sm:flex-col lg:flex-row lg:items-center lg:justify-between'}>
                            <h1 className={'text-[42px] sm:text-center'}>Computer Lab</h1>
